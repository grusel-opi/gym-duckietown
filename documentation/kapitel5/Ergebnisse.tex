...
\begin{table}[H]
	...
	\begin{tabular}[t]{|c|l|r|r|r|}
		\hline
		& \textbf{Kacheltyp} & \textbf{MAE $d$, $\theta$} & \textbf{n} & Chrashes \\
		\hline
		\multirow{4}{*}{PD} 
		& Alle
		& 12.59, 20.41
...
\begin{table}[H]
	...
	\begin{tabular}[t]{|c|l|r|r|r|}
		\hline
		& \textbf{Kacheltyp} & \textbf{MAE $d$} & \textbf{n} & Chrashes \\
		\hline
		\multirow{4}{*}{PD} 
		& Alle
		& 5.32
...
\begin{table}[H]
	...
	\begin{tabular}[t]{|c|l|r|r|r|}
		\hline
		& \textbf{Kacheltyp} & \textbf{MAE $\omega$} & \textbf{n} & Chrashes \\
		\hline
		\multirow{4}{*}{Expert} 
		& Alle
		& 0.096
