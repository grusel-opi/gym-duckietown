...
Wie in \ref{pd-angles} und \ref{pd-distances} erkennbar, ist die Verteilung von sowohl Entfernungswerten, als auch Winkeldifferenzen im  \glqq \acs{pd}-Rand\grqq{} Datensatz wesentlich gleichmäßiger als im \glqq \acs{pd}\grqq-Datensatz.
