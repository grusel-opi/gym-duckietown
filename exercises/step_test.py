...
aParticle = Particle(px, py, 1, 'p1', my_map, env,angle=env.cur_angle)
aParticle.set_tile()
print('start particle position und angle', aParticle.p_x, aParticle.p_y, aParticle.angle)
step_counter = 0
while True:
    ...
    print('pos_particle and angle', [aParticle.p_x,0.0 ,aParticle.p_y], aParticle.angle)
    print('pos_robot and angle', env.cur_pos, env.cur_angle)
    step_counter += 1
