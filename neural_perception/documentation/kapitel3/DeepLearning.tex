...
\begin{figure}[H]
	...
	\caption[Übersicht Künstliche Intelligenz]{Übersicht Künstliche Intelligenz \footnotemark}
	\label{overview-ki}
	\vspace{0.2cm}
\end{figure}

\footnotetext{\href{https://datasolut.com/wp-content/uploads/2019/11/KI-und-Deep-Learning.002-e1558385989498.jpeg}{https://datasolut.com/wp-content/uploads/2019/11/KI-und-Deep-Learning.002-e1558385989498.jpeg}}
...
\begin{figure}[H]
	...
	\caption[Darstellung eines beispielhaften künstlichen neuronalen Netzes]{Darstellung eines beispielhaften künstlichen neuronalen Netzes \\ (vereinfacht) \footnotemark}
	\label{simple-net}
	\vspace{0.2cm}
\end{figure}

\footnotetext{\url{https://datasolut.com/wp-content/uploads/2019/10/ku\%CC\%88nstliche-neuronale-Netze.jpg}}
...
\begin{figure}[H]
	...
	\caption[Darstellung der Performance von Deep Learning Algorithmen im Vergleich zu älteren Lernalgorithmen]{Darstellung der Performance von Deep Learning Algorithmen im Vergleich zu älteren Lernalgorithmen \footnotemark}
	\label{deep-learning-performance}
\end{figure}

\footnotetext{\url{https://datasolut.com/wp-content/uploads/2019/11/Warum-deep-learning-1024x742.png}}
...
\begin{figure}[H]
	...
	\caption[Darstellung der verschiedenen Lernverfahren]{Darstellung der verschiedenen Lernverfahren \footnotemark}
	\label{overview-machine-learning-algorithms}
	\vspace{0.2cm}
\end{figure}

\footnotetext{\url{https://1.bp.blogspot.com/-xstYqLb9OBw/XSYZUUD0WrI/AAAAAAAAML4/4sxvpGjIsDgmR7bDYyhcKdfM0TbvIIHdwCEwYBhgL/s400/machine-learning-lernverfahren.png}}
...
\subsubsection{Faltungsschicht (convolution layer)}
...
Eine weit verbreitete Methode um das Überstimmen (Overfitting) von neuronalen Netzen zu minimieren sind Dropout-Schichten. Die Idee ist, dass ein für das Netz wichtiges Merkmal nicht aus der Aktivierung eines einzelnen Neurons besteht, sondern aus der Kombination mehrerer.
...
Neuronale Netze bilden den Input über ihre Gewichte auf einen gewissen Output ab. Ist die Größenordnung mancher Gewichte größer als die von anderen, ist die Wahrscheinlichkeit hoch, dass das Netz überstimmt ist. Eine kleine Abweichung im Input kann dann drastische Auswirkungen auf den Output haben.
...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption[Lineare Klassifikation versus nichtlineare Klassifikation]{Lineare Klassifikation versus nichtlineare Klassifikation \footnotemark}
\end{figure}

\footnotetext{\url{https://www.informatik.uni-ulm.de/ni/Lehre/WS04/ProSemNN/pdf/MLP.pdf}}
...
\section{Convolutional Neural Networks (CNNs)}
	...
	In Abbildung \ref{cnn} kann man die Darstellung eines beispielhaften Convolutional Neural Networks sehen.
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.9\textwidth]{kapitel3/images/cnn.png}
		\caption[Darstellung eines beispielhaften \acs{cnn}]{Darstellung eines beispielhaften \acs{cnn} \footnotemark}
		\label{cnn}
		\vspace{0.2cm}
	\end{figure}

	\footnotetext{\url{https://de.wikipedia.org/wiki/Convolutional_Neural_Network\#/media/Datei:Typical_cnn.png}}
