...
\begin{itemize}
	...
	\item 
		\begin{tabular}[t]{lll}
			Gerader Streckenabschnitt & (befahrbar) & \hspace{0.8cm}
			$ \begin{array}{l}
				\setlength{\fboxsep}{0pt}
	...
	\item 
		\begin{tabular}[t]{lll}
			Linkskurve & (befahrbar) & \hspace{3.85cm}
			$ \begin{array}{l}
				\setlength{\fboxsep}{0pt}
	...
	\item 
		\begin{tabular}[t]{lll}
			3-Wege Kreuzung & (befahrbar) & \hspace{2.5cm}
			$ \begin{array}{l}
				\setlength{\fboxsep}{0pt}
	...
	\item 
		\begin{tabular}[t]{lll}
			4-Wege Kreuzung & (befahrbar) & \hspace{2.5cm}
			$ \begin{array}{l}
				\setlength{\fboxsep}{0pt}
	...
	\item 
		\begin{tabular}[t]{lll}
			Graskachel & (nicht befahrbar) & \hspace{2.85cm}
			$ \begin{array}{l}
				\setlength{\fboxsep}{0pt}
	...
	\item 
		\begin{tabular}[t]{lll}
			Bodenkachel & (nicht befahrbar) & \hspace{2.55cm}
			$ \begin{array}{l}
				\setlength{\fboxsep}{0pt}
...
Über die Methode \texttt{reset()} wird der Agent in einer zufälligen aber validen Pose platziert, also an einem befahrbaren und nicht durch andere Objekte besetzten Ort. Mit \texttt{render()} wird ein GL-Fenster geöffnet und ein Bild aus der Perspektive des Agenten angezeigt.\\
