...
In einer \textbf{DuckieTown-Umgebung} wird die \textbf{Umwelt} für einen \textbf{DuckieBot} definiert. Ein DuckieBot kann diese Umgebung dann \textbf{observieren} und sich in dieser \textbf{bewegen}. Eine DuckieTown-Umgebung wird dabei aus verschiedenen \textbf{Kacheln} und \textbf{Objekten} aufgebaut. 
