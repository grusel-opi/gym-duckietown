...
Beim maschinellen Lernen \acs{bzw} beim Deep Learning stehen drei unterschiedliche Lernverfahren zur Verfügung:
...
\section{Convolutional Neural Networks (CNNs)}
	...
	\acf{cnns} können besonders effizient mit \acs{2d}- \acs{bzw} \acs{3d}-Eingabedaten arbeiten. Insbesondere werden \acs{cnns} für die Objektdetektion in Bildern angewendet. \cite{datasolut4} \\
